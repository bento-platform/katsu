...
AGE = {
    "description": (
        "An ISO8601 duration string (e.g. P40Y10M05D for 40 years, 10 months, 5 days) representing an age of a subject."
    ),
...
GESTATIONAL_AGE = {
    "description": (
        "Gestational age (or menstrual age) is the time elapsed between the first "
...
TIME_STAMP = {"description": "In phenopackets we define the Timestamp as an ISO-8601 date time string."}

TIME_INTERVAL = {
    "description": "Indicates an interval of time",
    "properties": {"start": TIME_STAMP, "end": TIME_STAMP},
}
