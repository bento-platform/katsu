...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Biosample',
            fields=[
                ('biosample_id', models.CharField(help_text='An arbitrary identifier.', max_length=200, primary_key=True, serialize=False)),
                ...
                ('individual_age_at_collection', models.CharField(blank=True, help_text='Age of the proband at the time the sample was taken.', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_of_onset', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='An element representing the age of onset of the disease.', null=True)),
                ('tumor_stage', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True), blank=True, help_text='List of terms representing the tumor stage (TNM findings).', null=True, size=None)),
            ],
        ),
        migrations.CreateModel(
            name='Gene',
            fields=[
                ('gene_id', models.CharField(help_text='Official identifier of the gene.', max_length=200, primary_key=True, serialize=False)),
                ('alternate_id', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=200), help_text='Alternative identifier(s) of the gene.', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_type', django.contrib.postgres.fields.jsonb.JSONField(help_text='Ontology term that describes the phenotype.', verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('resource_id', models.CharField(help_text='For OBO ontologies, the value of this string MUST always be the official OBO ID, which is always equivalent to the ID prefix in lower case. For other resources use the prefix in identifiers.org.', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='phenopackets.Dataset')),
        ...
        migrations.CreateModel(
            name='Phenopacket',
            fields=[
                ('phenopacket_id', models.CharField(help_text='An arbitrary identifier for the phenopacket.', max_length=200, primary_key=True, serialize=False)),
                ...
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='phenopackets.Dataset')),
                ...
                ('phenotypic_features', models.ManyToManyField(blank=True, help_text='Phenotypic features observed in the proband.', to='phenopackets.PhenotypicFeature')),
                ('subject', models.ForeignKey(help_text='The proband.', on_delete=django.db.models.deletion.CASCADE, to='patients.Individual')),
                ('variants', models.ManyToManyField(blank=True, help_text='Variants identified in the proband.', to='phenopackets.Variant')),
            ],
        ),
        migrations.AddField(
            model_name='metadata',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interpretation_id', models.CharField(help_text='An arbitrary identifier for the interpretation.', max_length=200)),
                ...
                ('phenopacket', models.ForeignKey(help_text='The subject of this interpretation.', on_delete=django.db.models.deletion.CASCADE, to='phenopackets.Phenopacket')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='dataset',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='phenopackets.Project'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='biosample',
            name='individual',
            field=models.ForeignKey(blank=True, help_text='The id of the Individual this biosample was derived from.', null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.Individual'),
        ),
        migrations.AddField(
            model_name='biosample',
            name='phenotypic_features',
            field=models.ManyToManyField(blank=True, help_text='List of phenotypic abnormalities of the sample.', to='phenopackets.PhenotypicFeature'),
        ),
        migrations.AddField(
            model_name='biosample',
            name='procedure',
