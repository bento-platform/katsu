...
PHENOPACKET_EVIDENCE_SCHEMA = describe_schema(
    {
        ...
        "type": "object",
        "properties": {"evidence_code": ONTOLOGY_CLASS, "reference": PHENOPACKET_EXTERNAL_REFERENCE_SCHEMA},
        "additionalProperties": False,
...
PHENOPACKET_PROCEDURE_SCHEMA = describe_schema(
    {
        ...
        "type": "object",
        "properties": {"code": ONTOLOGY_CLASS, "body_site": ONTOLOGY_CLASS, "performed": TIME_ELEMENT_SCHEMA},
        "required": ["code"],
    },
...
REFERENCE_RANGE_SCHEMA = {
    ...
    "type": "object",
    "properties": {"unit": ONTOLOGY_CLASS, "low": base_type(SchemaTypes.NUMBER), "high": base_type(SchemaTypes.NUMBER)},
...
PHENOPACKET_TYPED_QUANTITY_SCHEMA = {
    ...
    "title": "Quantity schema",
    "type": "object",
    "properties": {"type": ONTOLOGY_CLASS, "quantity": PHENOPACKET_QUANTITY_SCHEMA},
...
PHENOPACKET_VALUE_SCHEMA = {
    ...
    "title": "Value schema",
    "type": "object",
    "oneOf": [named_one_of("quantity", PHENOPACKET_QUANTITY_SCHEMA), named_one_of("ontology_class", ONTOLOGY_CLASS)],
}
...
PHENOPACKET_COMPLEX_VALUE_SCHEMA = {
    ...
    "type": "object",
    "properties": {"typed_quantities": array_of(PHENOPACKET_TYPED_QUANTITY_SCHEMA)},
...
PHENOPACKET_DISEASE_ONSET_SCHEMA = {
    ...
    "type": "object",
    "anyOf": [AGE, AGE_RANGE, ONTOLOGY_CLASS],
}
...
EXTENSION_SCHEMA = describe_schema(
    {
        ...
        "content provider",
        "type": "object",
        "properties": {"name": base_type(SchemaTypes.STRING), "value": base_type(SchemaTypes.STRING)},
        "required": ["name", "value"],
    },
    {},
)
...
VARIATION_ONE_OF_SCHEMA = describe_schema(
    {
        ...
        "oneOf": [
            ...
            named_one_of("allele", {"$ref": sub_schema_uri(phenopacket_base_uri, "vrs#/definitions/Allele")}),
            named_one_of("genotype", {"$ref": sub_schema_uri(phenopacket_base_uri, "#/definitions/Genotype")}),
            named_one_of("haplotype", {"$ref": sub_schema_uri(phenopacket_base_uri, "#/definitions/Haplotype")}),
            named_one_of(
                "relative_copy_number",
                {"$ref": sub_schema_uri(phenopacket_base_uri, "#/definitions/RelativeCopyNumber")},
            ),
            named_one_of("text", {"$ref": sub_schema_uri(phenopacket_base_uri, "#/definitions/Text")}),
            named_one_of("variation_set", {"$ref": sub_schema_uri(phenopacket_base_uri, "#/definitions/VariationSet")}),
        ],
    },
    {},
)
...
PHENOPACKET_VARIANT_INTERPRETATION = describe_schema(
    {
        ...
        "type": "object",
        "properties": {
            "acmg_pathogenicity_classification": enum_of(
