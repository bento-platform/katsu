...
class TestDescriptions(TestCase):
    def test_descriptions(self):
        assert isinstance(describe_schema(None, "Test"), dict)
        self.assertDictEqual(describe_schema(TEST_SCHEMA_1, None), TEST_SCHEMA_1)

        d = describe_schema(TEST_SCHEMA_2, TEST_HELP_2)
    ...
    def test_help_get(self):
        assert rec_help(TEST_HELP_2, "[item]") == "2"
