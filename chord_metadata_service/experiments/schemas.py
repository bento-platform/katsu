...
EXPERIMENT_RESULT_SCHEMA = tag_ids_and_describe(
    {
        ...
        "properties": {
            ...
            "data_output_type": {"type": "string", "enum": ["Raw data", "Derived data"]},
            "usage": {"type": "string"},
...
EXPERIMENT_SCHEMA = tag_ids_and_describe(
    {
        ...
        "properties": {
            ...
            "library_layout": {"type": "string", "enum": ["Single", "Paired"]},
            "library_id": {
                "type": "string",
                "pattern": MODEL_ID_PATTERN,
            },
            "library_description": {"type": "string", "description": "Details about library construction."},
            "library_extract_id": {"type": "string"},
            "insert_size": {"type": "integer", "description": "Insert size (integer)."},
            "description": {"type": "string", "description": "Experimental design description."},
            "protocol_url": {"type": "string", "format": "uri", "description": "URL to the protocol."},
            ...
            "experiment_results": {"type": "array", "items": EXPERIMENT_RESULT_SCHEMA},
