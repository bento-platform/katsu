# Generated by Django 2.2.11 on 2020-03-20 18:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qc_flags', models.CharField(blank=True, help_text='Any quanlity control observations can be noted here. This field can be omitted if empty', max_length=30, null=True)),
                ...
                ('experiment_ontology_curie', models.CharField(blank=True, help_text='(Ontology: OBI) links to experiment ontology information.', max_length=30, null=True, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z]*:[A-Za-z0-9]*')])),
                ('molecule_ontology_curie', models.CharField(blank=True, help_text='(Ontology: SO) links to molecule ontology information.', max_length=30, null=True, validators=[django.core.validators.RegexValidator(regex='^[A-Za-z]*:[A-Za-z0-9]*')])),
