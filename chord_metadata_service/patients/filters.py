    ...
    def filter_search(self, qs, name, value):
        ...
        qs = qs.annotate(
            search=SearchVector("id", "alternate_ids", "date_of_birth",
                                ...
                                # Experiment fields
                                "phenopackets__biosamples__experiments__study_type",
                                "phenopackets__biosamples__experiments__experiment_type",
                                Cast("phenopackets__biosamples__experiments__experiment_ontology", TextField()),
                                "phenopackets__biosamples__experiments__molecule",
                                Cast("phenopackets__biosamples__experiments__molecule_ontology", TextField()),
                                "phenopackets__biosamples__experiments__library_strategy",
                                "phenopackets__biosamples__experiments__library_source",
                                "phenopackets__biosamples__experiments__library_selection",
                                "phenopackets__biosamples__experiments__library_layout",
                                "phenopackets__biosamples__experiments__extraction_protocol",
                                "phenopackets__biosamples__experiments__reference_registry_id",
                                Cast("phenopackets__biosamples__experiments__extra_properties", TextField()),
                                # Experiments: Experiment Results fields
                                "phenopackets__biosamples__experiments__experiment_results__description",
                                "phenopackets__biosamples__experiments__experiment_results__filename",
                                "phenopackets__biosamples__experiments__experiment_results__file_format",
                                "phenopackets__biosamples__experiments__experiment_results__genome_assembly_id",
                                "phenopackets__biosamples__experiments__experiment_results__data_output_type",
                                "phenopackets__biosamples__experiments__experiment_results__usage",
                                "phenopackets__biosamples__experiments__experiment_results__creation_date",
                                "phenopackets__biosamples__experiments__experiment_results__created_by",
                                Cast(
                                    "phenopackets__biosamples__experiments__experiment_results__extra_properties",
                                    TextField()
                                ),
                                # Experiments: Instrument fields
                                "phenopackets__biosamples__experiments__instrument__platform",
                                "phenopackets__biosamples__experiments__instrument__description",
                                "phenopackets__biosamples__experiments__instrument__model",
                                Cast(
                                    "phenopackets__biosamples__experiments__instrument__extra_properties",
                                    TextField()
                                ),
                                )
