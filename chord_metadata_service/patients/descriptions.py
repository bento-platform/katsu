...
INDIVIDUAL = {
    ...
    "properties": {
        ...
        "taxonomy": ontology_class(
            "specified when more than one organism may be studied. It is advised that codes"
...
VITAL_STATUS = {
    "description": (
        "This element can be used to report whether the individual is living or dead at the"
