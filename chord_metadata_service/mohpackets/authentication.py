...
#                 # logging.exception(
#                 #     f"An error occurred in get_authorized_datasets: {e}"
#                 # )
#                 raise AuthenticationFailed("Error retrieving authorized datasets")
...
#                     "Check if token is valid or access has been granted in OPA."
#                 )
#             else:
...
class LocalAuthentication(BaseAuthentication):
    def authenticate(self, request):
        ...
        # list of authorized datasets is in local settings
        authorized_datasets = [
            d["datasets"]
