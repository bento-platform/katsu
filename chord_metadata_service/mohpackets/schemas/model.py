...
class SpecimenModelSchema(BaseSpecimenSchema):
    ...
    submitter_donor_id: str = Field(..., alias="submitter_donor_id_id")
    submitter_primary_diagnosis_id: str = Field(
        ..., alias="submitter_primary_diagnosis_id_id"
    )
...
class SampleRegistrationModelSchema(BaseSampleRegistrationSchema):
    program_id: str = Field(..., alias="program_id_id")
    submitter_donor_id: str = Field(..., alias="submitter_donor_id_id")
    submitter_specimen_id: str = Field(..., alias="submitter_specimen_id_id")
...
class SurgeryModelSchema(BaseSurgerySchema):
    program_id: str = Field(..., alias="program_id_id")
    submitter_donor_id: str = Field(..., alias="submitter_donor_id_id")
    submitter_treatment_id: str = Field(..., alias="submitter_treatment_id_id")
...
class FollowUpModelSchema(BaseFollowUpSchema):
    program_id: str = Field(..., alias="program_id_id")
    submitter_donor_id: str = Field(..., alias="submitter_donor_id_id")
    submitter_primary_diagnosis_id: Optional[str] = Field(
        ..., alias="submitter_primary_diagnosis_id_id"
    )
    submitter_treatment_id: Optional[str] = Field(
        ..., alias="submitter_treatment_id_id"
    )
