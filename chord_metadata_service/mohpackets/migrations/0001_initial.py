    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_site', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=255, null=True), size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_rxnormcui', models.CharField(blank=True, max_length=64, null=True)),
                ('program_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.program')),
                ('submitter_donor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.donor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_name', models.CharField(blank=True, max_length=255, null=True)),
                ('drug_rxnormcui', models.CharField(blank=True, max_length=64, null=True)),
                ('hormone_drug_dosage_units', models.CharField(blank=True, max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_name', models.CharField(blank=True, max_length=255, null=True)),
                ('drug_rxnormcui', models.CharField(blank=True, max_length=64, null=True)),
                ('chemotherapy_dosage_units', models.CharField(blank=True, max_length=64, null=True)),
                ('cumulative_drug_dosage_prescribed', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('cumulative_drug_dosage_actual', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('program_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.program')),
                ('submitter_donor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.donor')),
