    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method_of_progression_status', models.CharField(blank=True, max_length=255, null=True)),
                ('anatomic_site_progression_or_recurrence', models.CharField(blank=True, max_length=255, null=True)),
                ('recurrence_tumour_staging_system', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=255, null=True), blank=True, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pack_years_smoked', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('program_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.program')),
                ('submitter_donor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mohpackets.donor')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('er_percent_positive', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('pr_status', models.CharField(blank=True, max_length=64, null=True)),
                ('pr_percent_positive', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
