...
urlpatterns = [
    ...
    path(
        "ingest-derived-experiment-results/<str:dataset_id>",
        views_ingest.ingest_derived_experiment_results,
    ...
    path(
        "data-types/<str:data_type>/metadata_schema",
        views_data_types.data_type_metadata_schema,
    ...
    path(
        "datasets/<str:identifier>/data-types",
        views_data_types.dataset_data_type_summary,
        name="chord-dataset-data-type-summary",
    ),
    path(
        "datasets/<str:identifier>/data-types/<str:data_type>",
        views_data_types.dataset_data_type,
        name="chord-dataset-data-type",
    ),
    path(
        "private/datasets/<str:identifier>/search", views_search.private_dataset_search, name="private-dataset-search"
    ),
]
