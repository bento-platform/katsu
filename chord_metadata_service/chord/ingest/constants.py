...
from chord_metadata_service.chord.data_types import KatsuDataType, DATA_TYPE_EXPERIMENT, DATA_TYPE_PHENOPACKET
...
DATA_TYPE_TO_VALIDATOR_FN: dict[KatsuDataType, Callable] = {
    DATA_TYPE_EXPERIMENT: validate_experiment,
    DATA_TYPE_PHENOPACKET: validate_phenopacket,
}

DATA_TYPE_TO_INGESTION_FN: dict[KatsuDataType, Callable] = {
