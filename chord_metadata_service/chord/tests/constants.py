...
VALID_DATA_USE_1 = {
    "consent_code": {"primary_category": {"code": "GRU"}, "secondary_categories": [{"code": "GSO"}, {"code": "RU"}]},
    "data_use_requirements": [{"code": "COL"}, {"code": "MOR"}, {"code": "US"}],
}
...
DEFAULT_PROJECT_JSON_SCHEMA = {
    "type": "object",
    "properties": {"string_prop": {"type": "string"}, "bool_prop": {"type": "boolean"}, "obj_prop": {"type": "object"}},
}
...
def valid_project_json_schema(
    project_id: str,
    schema_type=SchemaType.PHENOPACKET,
    required: bool = False,
    json_schema: dict = DEFAULT_PROJECT_JSON_SCHEMA,
):
    return {"project": project_id, "required": required, "schema_type": schema_type, "json_schema": json_schema}
...
TEST_SEARCH_QUERY_4 = [
    "#eq",
    ["#resolve", "biosamples", "[item]", "sampled_tissue", "label"],
    "wall of urinary bladder",
]
TEST_SEARCH_QUERY_5 = ["#ico", ["#resolve", "phenotypic_features", "[item]", "type", "label"], "proptosis"]
TEST_SEARCH_QUERY_6 = ["#ico", ["#resolve", "biosamples", "[item]", "sampled_tissue", "label"], "URINARY BLADDER"]
